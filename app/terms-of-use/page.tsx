      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 p-4 bg-white text-black lg:px-16 lg:py-10 relative">
        ...
        <div className="col-span-2">
          <div className=" space-y-6">
            <div>
              ...
              <p className="font-normal ">
                ...
                shares and protects any information that you give Revve when you
                ...
                subscribing to our services; you can be assured that it will
            ...
            <div>
              ...
              <p className="font-normal ">
                ...
                without explicit consent sought, given or accepted where (i) it
                is necessary for entering into or performance of a contract;
                (ii) it is authorized or required by law (which also provides
                safeguards for You); or (iii) there are circumstances that may
                engender direct or indirect propagation of criminal acts and
            ...
            <div>
              ...
              <p className="font-normal ">
                ...
                <br /> We may also collect information you provide us including
                but not limited to information on web forms, account update
                information and correspondence with the Platform support
                services team. Information obtained through voluntary
              ...
              <p className="font-normal  ">
                ...
                your computer, mobile phone, or other electronic access devices.
              </p>
              <p className="pt-4">
                The automatically collected information includes but is not
                limited to data about the pages you access, computer IP address,
                device ID or unique identifier, device type, geo-location
                information, computer and connection information, mobile network
                information, statistics on page views, ad data, the dates and
                times of your use of the Platformand standard web log data. We
                may combine this information with other information that we
                collect from you. Revve may engage in activities which involve
                the automated processing and/or profiling of information you
                provide us where (i) it is necessary for entering into or
                performance of a contract; (ii) it is authorized by law (which
                also provides safeguards for you); or (iii) it is the subject of
            ...
            <div>
              ...
              <p>
                We primarily use your Information to provide Services to you and
                to respond to your inquiries. We also may use your Information
                as follows:
              </p>
              <ol className=" list-decimal pl-6 space-y-1.5">
                <li>
                  To communicate with you, including to respond to your comments
                  or requests for information, to request feedback on our
                  products and services, and to notify you about changes to the
                  services you use.
                </li>
                <li>
                  To help Revve understand you, to tailor and enhance our
                  product and service offerings, anticipate and resolve problems
                  with any products or services supplied to you, create products
                  or services that may meet your needs.
                </li>
                <li>
                ...
                <li>
                  ...
                  applicable law about products, services and opportunities that
                  we believe would be of interest to you, including products and
                  services offered by third parties.
                </li>
                <li>
                  To protect our rights, your rights, and the rights of others,
                  and to meet our own high standards of business practice.
                </li>
              </ol>
              <p className="pt-4">
              ...
              <p className="pt-4">
                Each time you provide us with Information we aim to let you know
                how we intend to use it and ask you to give your consent to such
                use.
              </p>
              <p className="pt-4">
                Revve may assign its obligations and rights under this Policy to
                an Affiliate or a successor entity and your Information as well
                as the use and processing of such Information may be among the
                assets transferred by Revve. You acknowledge and consent that
          ...
          <div>
            ...
            <p className="font-normal ">
              Information collected will be held securely and will only be kept
              for as long as is reasonably necessary for as long as you use the
              service or product that you are subscribed to, unless you have
              provided us with your consent to use the data for any additional
              purposes. We take the security of the information you provide very
              seriously, and we will take all appropriate technical,
              administrative and physical safeguards/measures using recognized
              security procedures and tools in accordance with good industry
            ...
            <p className="pt-4">
              ...
              information under our control, but, to the extent allowed by law,
              Revve assumes no liability for any damage you may suffer as a
              result of interception, alteration or misuse of information
              transmitted over the Internet. Whilst we use all reasonable
              endeavors to protect your security in the manner described above,
              we consider that it is only appropriate to advise users that data
              transmission over the Internet and the World Wide Web cannot be
          ...
          <div>
            ...
            <ol className=" list-decimal pl-6 space-y-1.5">
              <li>
                How long you have been a customer with us, the types products or
                services offering we provide you, and when you will stop being
                our customer.
              </li>
              <li>
                After you have stopped being our customer, for how long it is
                reasonable for us to retain your records to show we have met the
                obligations we have to you and by law.
              </li>
              <li>Any time limits for making a claim</li>
              <li>
                Any period for keeping your Information which are set by law or
                recommended by the relevant regulators, professional bodies or
                associations or is in line with best practice.
              </li>
            ...
            <p className="pt-2">
              In respect of your Information with us you can do at any time the
              following by contacting us:
            </p>
            <ol className=" list-disc pl-6 space-y-1.5">
              ...
              <li>
                Change/correct any Information we have about you after providing
                the required documentation and if it is within your purview to
                change/correct.
              </li>
              <li>
                If allowable, and subject to points a – h above, have us delete
                any Information we have about you.
              </li>
              <li>
                If allowable, request for the purpose of the processing as well
              ...
              <li>
                ...
                making, such as profiling, and any meaningful information about
                the logic involved, as well as the significance and expected
                consequences of such processing and express any concern about
          ...
          <p className="pt-2">
            Yes. A cookie is a small file which asks permission to be placed on
            ...
            remembering information about your preferences. Cookies are features
            included in your browser and will store small amounts of data on
            your computer about your visit to the Website, in particular when
            you complete any form on the Website.
          </p>
          <p className="pt-4">
            However, a cookie does not provide us with any Information.
            Therefore, if you have not supplied us with any Information, you can
            still browse our site anonymously. This information is used only for
            administration of the site system and in the compilation of
            statistics used by Revve. Cookies may be required to allow you to
            access and participate in certain areas of our Website. The majority
            of browsers will allow you to alter the settings used for cookies
          ...
          <p>
            shall be liable, in addition to any other civil liabilities, to any
            penalties provided in such data protection laws.
          </p>
          ...
          <p className="">
            By accessing the services of Revve on any platform, you agree to be
            governed by the laws of Canada. The laws of Canada will govern all
            matters relating to this Privacy Policy and shall apply without
            regard to the principles of conflict of laws. You agree to submit to
            the exclusive jurisdiction and venue of the Courts in Canada.
          </p>

          <p className="pt-6">
            Copyright ©{new Date().getFullYear()} [Revve]. All Rights Reserved.
          </p>
        </div>
      </div>
