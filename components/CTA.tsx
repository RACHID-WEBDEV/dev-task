...
const CTA = ({ setOpenModal }: any) => {
  return (
    <section className="relative bg-cover bg-center w-full h-[550px] lg:h-[950px] bg-no-repeat bg-[url('/images/pay-bills.png')] overflow-hidden">
      <div className=" absolute top-[55%] lg:top-[45%] 1xl:top-[50%] 2xl:top-[60%] transform -translate-y-1/2 w-full">
        <div className=" flex justify-between flex-wrap gap-8 px-4 lg:pt-0 lg:px-20">
          ...
          <div className="lg:pt-0 mb-10 hidden lg:block">
            {/* <Image
