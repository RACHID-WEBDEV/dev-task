...
const MultiCurrency = () => {
  return (
    <>
      <section className="relative bg-cover bg-center w-full h-[900px] lg:h-[1000px] bg-no-repeat bg-gray-100 overflow-hidden">
        <div
