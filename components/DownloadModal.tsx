                ...
                <div className="  ">
                  ...
                  <div className="mt-4  text-gray-800 ">
                    ...
                    <div className="flex items-center gap-2.5 justify-center flex-wrap my-6">
                      <a
                        href="https://play.google.com/store/apps/details?id=com.revvemobile&pcampaignid=web_share"
                        target="_blank"
                      >
                        <button
                          type="button"
                      ...
                      <a
                        href="https://apps.apple.com/ng/app/revve-send-and-receive-money/id6497335006"
                        target="_blank"
                      >
                        <button
                          type="button"
